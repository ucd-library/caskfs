...
-- Function to find files where this file's object URIs point to other files' subject URIs
-- CREATE OR REPLACE FUNCTION caskfs.get_file_references(p_file_id UUID)
-- RETURNS TABLE(
--     file_id UUID,
--     containment VARCHAR,
...
--             target_view.subject as target_object
...
--         WHERE source_view.file_id = p_file_id
--         AND target_view.file_id != p_file_id 
--     ),
--     nodes AS (
--         SELECT 
--             target_view.file_id,
...
-- CREATE OR REPLACE FUNCTION caskfs.get_file_referenced_by(p_file_id UUID)
-- RETURNS TABLE(
--     file_id UUID,
--     containment TEXT,
--     target_subject VARCHAR,
--     predicate VARCHAR,
...
--           source_view.subject = target_view.object AND 
--           target_view.file_id != p_file_id;
-- END;
-- $$ LANGUAGE plpgsql;
